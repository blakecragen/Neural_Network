...
class RandomForest(object):
    ...
    def _bootstrapping(self, num_training, num_features, random_seed=None):
        ...
        num_selected_features = int(np.floor(self.max_features * num_features))
    ...
    def fit(self, X, y):
        ...
        for tree, bootstrap_rows, features in zip(self.decision_trees, self.bootstraps_row_indices, self.feature_indices):
            X_subset = X[bootstrap_rows][:, features]
            y_subset = y[bootstrap_rows]
    ...
    def plot_feature_importance(self, data_train):
        ...
        sorted_features = feature_names[indices_sorted]
        sorted_importances = feature_importances[indices_sorted]
